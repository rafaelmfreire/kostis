...
const form = reactive({
  income: props.revenue.income_in_dollars,
  date: new Date(props.revenue.date).getFullYear()+'-'+(new Date(props.revenue.date).getMonth()+1).toString().padStart(2, '0')+'-'+new Date(props.revenue.date).getDate().toString().padStart(2, '0'),
  description: props.revenue.description,
  observation: props.revenue.observation,
});
