...
<template>
        <button :class="{ 'bg-indigo-300 border-2 border-indigo-700 font-bold text-indigo-700': isCurrentMonth(refMonth) }" class="" @click="addMonth(props.refMonth)">{{ getMonth(props.refMonth) }}</button>
</template>